...
export const departmentTemplates: Record<string, { name: string; ckp: string }[]> = {
  'div-1': [
    { name: 'Відділ власника', ckp: 'Розроблена та впроваджена стратегія розвитку компанії' },
    { name: 'Виконавчий відділ', ckp: 'Скоординована та ефективна робота всіх відділень' },
  ],
  'div-2': [
    { name: 'Відділ маркетингу', ckp: 'Кваліфіковані ліди, що надійшли до відділу продажів' },
    { name: 'Відділ контенту', ckp: 'Створений та опублікований контент, що приваблює цільову аудиторію' },
  ],
  'div-3': [
    { name: 'Бухгалтерія', ckp: 'Правильно розраховані та вчасно сплачені податки та зарплати' },
    { name: 'Фінансовий відділ', ckp: 'Складений та затверджений фінансовий план (бюджет)' },
  ],
  'div-4': [
    { name: 'Виробничий відділ', ckp: 'Вироблений та переданий на склад якісний продукт' },
    { name: 'Відділ логістики', ckp: 'Своєчасно доставлений клієнту продукт без пошкоджень' },
  ],
  'div-5': [
    { name: 'Відділ персоналу (HR)', ckp: 'Продуктивний співробітник, що успішно пройшов випробувальний термін' },
    { name: 'Відділ контролю якості', ckp: 'Виявлені та виправлені невідповідності продукту стандартам' },
  ],
  'div-6': [
    { name: 'Відділ продажів', ckp: 'Отримані гроші на рахунках компанії від клієнтів' },
    { name: 'Відділ по роботі з клієнтами', ckp: 'Задоволений постійний клієнт, що робить повторні покупки' },
  ],
  'div-7': [
    { name: 'Відділ розробки нових продуктів', ckp: 'Розроблений та протестований новий продукт, готовий до запуску' },
    { name: 'IT-відділ', ckp: 'Безперебійно працююча IT-інфраструктура компанії' },
  ],
};
