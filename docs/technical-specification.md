...
Сторінка та логіка для входу користувачів у систему. Детальний покроковий опис цього процесу знаходиться у файлі [`docs/login-flow.md`](./login-flow.md).

- **UI сторінки входу:** Відображається картка з назвою додатку та однією кнопкою "Увійти через Telegram".
  - **Статус:** ✅ Реалізовано.

- **Процес автентифікації:** Повністю делеговано зовнішньому бекенду.
  - **Статус:** ✅ Реалізовано.
